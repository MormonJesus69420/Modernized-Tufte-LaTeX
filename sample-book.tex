...
This version of \TL\ uses \docpkgdef{ETbb} for a Bembo-like font, \docpkgdef{gillius} for a \textsf{Gill Sans-like font}, and \docpkgdef{FiraMono} as a \texttt{monospaced font}.
...
%%% TODO: Continue with the rest of the document
