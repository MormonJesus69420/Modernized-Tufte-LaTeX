...
By default the \doccls{tufte-book} class uses the \docclsopt{twoside} option, as it is based on the \doccls{book} class.
If you wish to disable it you can use the \docclsopt{oneside} option.
...
This is the way how books are traditionally printed, but Tufte's book design places the sidenotes on the right side of every page.
