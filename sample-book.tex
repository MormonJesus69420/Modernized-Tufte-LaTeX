...
As you can see this sample document does its best to emulate the design of \BE, but it's not perfect.
...
On a personal note, placing of sidenotes should follow the following rules:
\begin{itemize}
...
In the new version of \TL, it's impossible to offset citation's position the same way sidenotes can be moved up or down the margin.
