...
\Cref{fig:full-width-figure} is an example of the \docenv{figure*} environment and \cref{fig:text-figure} is an example of the normal \docenv{figure} environment.
...
\paragraph{Typefaces}\label{par:typefaces}
...
\newthought{The ``Sample Book'' and the project's readme} provide a simplified \texttt{makefile}, with only the necessary targets for most use-cases.
...
\pagebreak
\section{Troubleshooting and Support}\label{sec:troubleshooting-support}
\subsection{\TL\ Website}\label{ssec:tufte-latext-website}
...
\subsection{\TL\ Mailing Lists}\label{ssec:tufte-latex-mailing-lists}
...
\subsection{Package Dependencies}\label{ssec:package-dependencies}
